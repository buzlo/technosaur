      ...
      <form class="cart__form form" action="#" method="POST"
        ...
        <div class="cart__field">
          <div class="cart__data">
            ...
            <BaseFormText v-model="formData.phone" type="tel" :error="formError.phone"
        ...
        <div class="cart__block">
          <ul class="cart__orders">
            <CartOrder v-for="cartItem of cartItems"
              :key="cartItem.productId" :cartItem="cartItem"/>
          </ul>
          <div class="cart__total">
            <p>Доставка: <b>500 ₽</b></p>
            <p>Итого: <b>{{ cartItems.length }}</b> товара
...
export default {
  components: { BaseFormText, BaseFormTextarea, CartOrder },
  data() {
    return {
      formData: {},
      formError: {},
